...
```{r}
MB5371_Meta <- read.csv("MB5371_Metadata.csv", header = TRUE)
MB5371_Detections <- read.csv("MB5371_Detections.csv", header = TRUE)
MB5371_Receivers <- read.csv("MB5371_Receivers.csv", header = TRUE)
